...
/* WIGEND Cotrollor*/
static struct resource s3c_wig_resource[] ={
	[0] = {
		.start = 0x18000000,
		.end   = 0x1800000f,
		.flags = IORESOURCE_MEM,
...
struct platform_device s3c_device_wig = {
	.name          = "s3c2410-wig",
	.id            = -1,
	.num_resources = ARRAY_SIZE(s3c_wig_resource),
	.resource      = s3c_wig_resource
};

EXPORT_SYMBOL(s3c_device_wig);
