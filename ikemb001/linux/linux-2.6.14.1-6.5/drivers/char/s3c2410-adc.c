...
int ReadAdc(int ch)
{
    ...
    ret=readw(adc_base + S3C2410_ADCCON);
    ret= ret + S3C2410_ADCCON_STARTMASK;   //start ADC
   // printk("ADCCON is %x\n",ret);
    ...
    ret=readw(adc_base + S3C2410_ADCCON) & S3C2410_ADCCON_ECFLG;
    ret=readw(adc_dat_base) & S3C2410_ADCDAT0_XPDATA_MASK;
