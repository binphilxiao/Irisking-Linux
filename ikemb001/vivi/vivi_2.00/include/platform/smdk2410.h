...
/* 203.00 MHz */
#define MDIV_203		0x90
#define PDIV_203		0x07
#define SDIV_203		0x00

/* 270.00 MHz */
#define MDIV_270		0x7f
#define PDIV_270		0x04
#define SDIV_270		0x00
...
#define vBWSCON			0x22160a10
#define vBANKCON0		0x00000700
#define vBANKCON1		0x00007f00
#define vBANKCON2		0x00007f00
#define vBANKCON3		0x00007f00
#define vBANKCON4		0x00007f40
#define vBANKCON5		0x00000700
#define vBANKCON6		0x00018005
#define vBANKCON7		0x00018005
//#define vREFRESH		0x008e0459
#define vREFRESH		0x009e03e5  // trp=3,tsrc=7,refresh 9978
...
#define vUART_FREQ		50750000
#define vMPLLCON_50		((MDIV_50 << 12) | (PDIV_50 << 4) | (SDIV_50)) 
#define vMPLLCON_USER		((MDIV_203 << 12) | (PDIV_203 << 4) | (SDIV_203)) 
