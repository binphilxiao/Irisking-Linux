...
#define CROSS_COMPILER_PREFIX "/usr/local/arm/3.4.1/bin/arm-linux-"
...
#define ENABLE_FEATURE_TFTP_DEBUG 1
#define USE_FEATURE_TFTP_DEBUG(...)  __VA_ARGS__
#define SKIP_FEATURE_TFTP_DEBUG(...)
